...
include('Header6.php');//header file
include('footer1.php'); 
...
<div>
  <div class="search">
    <form id='search' class="search-container" method="POST">
       <input type='text' placeholder='Teacher Name' class="searchinput-field" name='searchTerm'>
...
<td><?php echo "<a class='button-1' href='classadd1.php?class_id={$info['classID']}'>Add</a>";?></td>
<td><?php echo "<a class='button-8' href='delete_student1.php?classID=".$info['classID']."'>Delete</a>"?></td>
