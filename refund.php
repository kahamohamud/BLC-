...
include('Header0.php');//header file
include('footer1.php'); 
...
<div>
  ...
  <button class="button-9" onclick="window.location.href='RefundNew.php';">Add a New Refund Statement</button>
</div>
...
<td><?php echo $info['RefundRef']; ?></td>
  ...
  <td><a class='button-7' onclick="return confirm('Are You Sure to Update This');" href='refundf.php?refund=<?php echo $info['RefundRef']; ?>'>Edit</a></td>
  <td><a class='button-1' href='refundview.php?refund=<?php echo $info['RefundRef']; ?>'>View</a></td>
</tr>
</tbody>
<?php
}
