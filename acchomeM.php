...
include('accheaderM.php');//header file
include('footer.php'); 
session_start();
error_reporting(0);
...
<?php
   ...
   <div class="content">
      ...
      <div class="card">
            ...
            <a class="title" href="Accounting1.php">Finance</a>
    ...
    <div class="card">
         ...
         <a class="title" href="rechome1.php">Receipt</a>
   ...
   <div class="card">
            ...
            <a class="title" href="refund1.php">Refund</a>
