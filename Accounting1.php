...
include('Header7F.php');//header file
include('footer1.php'); 
...
<div>
  ...
  <button class="button-9" onclick="window.location.href='Invoicenew1.php';">Add a New Invoice</button>
</div>
...
<td><?php echo $info['Ref']; ?></td>
  ...
  <td><a class='button-7' onclick="return confirm('Are You Sure to Update This');" href='accountingedit1.php?accountingedit=<?php echo $info['Ref']; ?>'>Edit</a></td>
  <td><a class='button-1' onclick="return confirm('Are You Sure to Update This');" href='Invoice1.php?Invoice=<?php echo $info['Ref']; ?>'>View</a></td>
</tr>
<!-- </tr> -->
</tbody>
<?php
