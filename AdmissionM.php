...
<body>
 ...
 <div class="container-wrapper">
  ...
  <button class="button-9" onclick="window.location.href='AdmissionNew1.php';">Add A New Student</button>
</div>
...
<tbody>
  ...
  <td><a class='button-7' onclick="return confirm('Are You Sure to Update This');" href='Aedit1.php?Aedit=<?php echo $info['studentPassportNo']; ?>'>Edit</a></td>
  <td><a class='button-1' href='Aview1.php?admitview=<?php echo $info['studentID']; ?>'>View</a></td>
</tr>
  </tbody>
<?php
}
