...
<option value="ZIMBABWEAN">ZIMBABWEAN</option>
                   ...
                   maxlength="11">
                        ...
                        <div class="input-field">
                            <label>Registration & Visa Processing Fee</label>
                   ...
                   size="50%">
                        ...
                        <div class="input-field">
                            <label>Airport Clearance and Pickup Fee</label>
                            <input type="number"name= "ACPfee" onkeypress="return onlyNumberKey(event)" 
                   maxlength="11" 
                   size="50%">
                        </div>
...
<!-- </form> -->
  <!-- <button class="submit" onclick="location.href='offerletter.php'">Back</button> -->
        ...
        <button class="submit" onclick="location.href='offerletter.php'"> <i class="fas fa-arrow-left"></i> </button>
