...
include('headerx.php');//header file
include('footer.php'); 
...
<div class="filter">
  ...
  <td><a class='button-7' onclick="return confirm('Are You Sure to update This');" href='academicedit2.php?AcademidEdite=<?php echo $info['ID'];?>'>Edit</a></td>
  <td><a class='button-1' href='academicview1.php?AcademidEdite1=<?php echo $info['ID'];?>'>View</a></td>
        </tr>
      <?php
      }
      ?>
