...
include('academicheader.php');//header file
include('footer.php'); 
session_start();
error_reporting(0);
...
<?php
   ...
   <div class="content">
      ...
      <div class="card">
            ...
            <a class="title" href="Aacademic.php">Academic</a>
    ...
    <div class="card">
         ...
         <a class="title" href="stafftimetable.php">Timetable</a>
         <p class="text">Add and manage student/ check time table</p>
