...
include('Header10.php');//header file
include('footer1.php'); 
...
<div>
  ...
  <button class="button-9" onclick="window.location.href='recnew.php';">Add a New Receipt</button>
</div>
...
<td><?php echo $info['Rref']; ?></td>
  ...
  <td><a class='button-7' onclick="return confirm('Are You Sure to Update This');" href='recieptform.php?reciept=<?php echo $info['Rref']; ?>'>Edit</a></td>
  <td><a class='button-1' href='recieptView.php?recieptV=<?php echo $info['Rref']; ?>'>View</a></td>
</tr>
</tbody>
<?php
}
